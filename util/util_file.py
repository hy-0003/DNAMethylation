...
if __name__ == '__main__':
    ...
    config.path_train_data = '../MEDNA-DFM/data/DNA_MS/tsv/6mA/6mA_A.thaliana/train.tsv'
    config.path_test_data = '../MEDNA-DFM/data/DNA_MS/tsv/6mA/6mA_A.thaliana/test.tsv'
