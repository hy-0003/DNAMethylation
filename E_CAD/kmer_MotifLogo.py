...
# 5hmC Data   '5hmC_H.sapiens','5hmC_M.musculus'
# 4mC Data    '4mC_C.equisetifolia','4mC_F.vesca','4mC_S.cerevisiae','4mC_Tolypocladium'
# 6mA Data    '6mA_A.thaliana''6mA_C.elegans''6mA_C.equisetifolia''6mA_D.melanogaster'
# 6mA Data    '6mA_F.vesca''6mA_H.sapiens''6mA_R.chinensis''6mA_S.cerevisiae''6mA_T.thermophile''6mA_Tolypocladium''6mA_Xoc BLS256'

# Please change your path
# K-mer score txt path
KMER_SCORES_FILE = r'MEDNA-DFM\CAD\6mA_D.melanogaster\CAD_Result\6mer_CAD.txt'
# test data path
SEQUENCE_DATA_FILE = r'MEDNA-DFM\data\DNA_MS\tsv\6mA\6mA_D.melanogaster\test.tsv'
# Motif Logo saved path
OUTPUT_LOGO_FILE = r'MEDNA-DFM\CAD\6mA_D.melanogaster\CAD_Result\Motif_Logo_6mer.svg'
